## This is an old code file that I wrote that implements a potential field pathfinding algorithm that 
## considers repulsive forces from nearest neighbor obstacles. 
## This file will be replaced very soon, but I am keeping it here for the time being since it's my only code
## were I implement this kind of potential field algorithm.
## The code I will replace it with will be an implementation of the algorithm along with an
## organized demonstration of the algorithm's capabilities, in line with the rest of the demonstrations in this repository.
